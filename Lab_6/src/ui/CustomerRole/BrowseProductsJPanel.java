...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        // TODO add your handling code here:
        //put current order into masterorderList and generate new oder
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please check the modified fields");
            return; //get new quantity
        }
        
        int oldQuant = item.getQuantity(); //save oldQuant 
            if(item.getProduct().getAvail()+oldQuant < quant){ //check oldQuant
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        userProcessContainer.add("ViewProductDetailJPanel", voidp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(salesPrice < product.getPrice()){
            JOptionPane.showMessageDialog(this, "Price should be more than it set in the price");
            return;
        }
        ...
        if(item == null){
            if(product.getAvail() >= quant){
                ...
                product.setAvail(product.getAvail()-quant);//number add to cart
