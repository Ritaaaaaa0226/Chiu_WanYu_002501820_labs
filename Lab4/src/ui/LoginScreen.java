...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbSupplier.setText("Select Supplier:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbSupplier, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(selectedPanel.getClass() == SupplierWorkAreaJPanel.class){
            if(selectedSupplier == null){
                JOptionPane.showMessageDialog(this, "Please select a supplier to login uder supplier role.");
                return;
            }else{
