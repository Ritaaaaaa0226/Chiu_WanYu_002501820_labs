...
public void refreshTable() {
    ...
    for (Supplier supplier : supplierDirectory.getSupplierList()) { // Assume this method returns a list of suppliers
        Object[] row = new Object[1];
        row[0] = supplier; // Assuming supplier.toString() gives the supplier's name
        model.addRow(row);
    }
}
}
