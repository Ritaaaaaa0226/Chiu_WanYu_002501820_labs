...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    JOptionPane.showMessageDialog(null, "No products available.", "Information", JOptionPane.INFORMATION_MESSAGE);
    return;
}
    ...
    // Add the new panel to the workArea and switch the layout
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int row = tblProducts.getSelectedRow();
         if (row<0){
          ...
          Product selectedProduct = (Product)tblProducts.getValueAt(row,0);
          supplier.getProductCatalog().removePorduct(selectedProduct);
          refreshTable();
